...
## 🎯 Features
* 🤖 **AI-Powered Commit Messages** - Uses Hugging Face AI to generate meaningful commit messages
...
4. **Set up AI (Optional but Recommended):**
   ...
   - Run `DevChronicle: Set Hugging Face API Key`
...
5. Run `DevChronicle: Set Hugging Face API Key` in VS Code
...
* Commands:
   * `DevChronicle: Set Hugging Face API Key` - Configure AI
